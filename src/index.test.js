...
test('Decorator function, created with decorateWithOptions(originalDecorator)', t => {
  test('called as @decorator', t => {
    ...
    t.equal(originalDecorator.calledWithExactly(Class), true, 'should call original decorator with Class as an argument');
  ...
  test('called as decorator(ClassOrFunction)', t => {
    ...
    t.equal(originalDecorator.calledOnce, true, 'should result in one call to original decorator');
    t.equal(originalDecorator.calledWithExactly(Class), true, 'should call original decorator with Class or Function as an argument');
  ...
  test('called as decorator(ClassOrFunction, options)', t => {
    ...
    t.equal(originalDecorator.calledWithExactly(Class, options), true, 'should call original decorator with Class or Function and options as arguments');
    t.equal(DecoratedClass.isDecorated, true, 'should result in the decorated Class')
  ...
  test('called as decorator(ClassOrFunction, option1, option2, ...)', t => {
    ...
    t.equal(originalDecorator.calledOnce, true, 'should result in a call to original decorator');
    t.equal(originalDecorator.calledWithExactly(Class, option1, option2), true, 'should call original decorator with Class or Function and options as arguments');
    t.equal(DecoratedClass.isDecorated, true, 'should result in the decorated Class')
  ...
  test('called as @decorator()', t => {
    ...
    t.equal(originalDecorator.calledOnce, true, 'should result in one call to original decorator');
    t.equal(originalDecorator.calledWithExactly(Class), true, 'should call original decorator with Class and options as arguments');
    t.equal(Class.isDecorated, true, 'should result in the decorated Class')
  ...
  test('called as @decorator(options)', t => {
    ...
    t.equal(originalDecorator.calledOnce, true, 'should result in one call to original decorator');
    t.equal(originalDecorator.calledWithExactly(Class, options), true, 'should call original decorator with Class and options as arguments');
    t.equal(Class.isDecorated, true, 'should result in the decorated Class')
  ...
  test('called as @decorator(option1, option2, ...)', t => {
    ...
    t.equal(originalDecorator.calledOnce, true, 'should result in one call to original decorator');
    t.equal(originalDecorator.calledWithExactly(Class, option1, option2), true, 'should call original decorator with Class and options as arguments');
    t.equal(Class.isDecorated, true, 'should result in the decorated Class')
...
function createDecorator() {
  return sinon.spy(function (ClassOrFunction) {
